...
import '../../../../linkApi.dart';
import '../../items/emptyItemsWidget.dart' show EmptyItemsWidget;

class CustomSearchItemsHomepage extends StatelessWidget {

  final List<ItemsModel> searchItems;

  const CustomSearchItemsHomepage({super.key,required this.searchItems});
